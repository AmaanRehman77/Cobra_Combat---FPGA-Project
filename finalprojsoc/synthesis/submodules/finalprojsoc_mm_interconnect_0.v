...
module finalprojsoc_mm_interconnect_0 (
		...
		output wire [1:0]  random_coordinate_s1_address,                   //                     random_coordinate_s1.address
		output wire        random_coordinate_s1_write,                     //                                         .write
		input  wire [31:0] random_coordinate_s1_readdata,                  //                                         .readdata
		output wire [31:0] random_coordinate_s1_writedata,                 //                                         .writedata
		output wire        random_coordinate_s1_chipselect,                //                                         .chipselect
	...
	wire   [17:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> hex_digits_pio_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> leds_pio_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> x_velocity_s1_agent:cp_channel
	...
	wire   [17:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> y_velocity_s1_agent:cp_channel
	...
	wire   [31:0] random_coordinate_s1_agent_m0_readdata;                                             // random_coordinate_s1_translator:uav_readdata -> random_coordinate_s1_agent:m0_readdata
	wire          random_coordinate_s1_agent_m0_waitrequest;                                          // random_coordinate_s1_translator:uav_waitrequest -> random_coordinate_s1_agent:m0_waitrequest
	wire          random_coordinate_s1_agent_m0_debugaccess;                                          // random_coordinate_s1_agent:m0_debugaccess -> random_coordinate_s1_translator:uav_debugaccess
	wire   [27:0] random_coordinate_s1_agent_m0_address;                                              // random_coordinate_s1_agent:m0_address -> random_coordinate_s1_translator:uav_address
	wire    [3:0] random_coordinate_s1_agent_m0_byteenable;                                           // random_coordinate_s1_agent:m0_byteenable -> random_coordinate_s1_translator:uav_byteenable
	wire          random_coordinate_s1_agent_m0_read;                                                 // random_coordinate_s1_agent:m0_read -> random_coordinate_s1_translator:uav_read
	wire          random_coordinate_s1_agent_m0_readdatavalid;                                        // random_coordinate_s1_translator:uav_readdatavalid -> random_coordinate_s1_agent:m0_readdatavalid
	wire          random_coordinate_s1_agent_m0_lock;                                                 // random_coordinate_s1_agent:m0_lock -> random_coordinate_s1_translator:uav_lock
	wire   [31:0] random_coordinate_s1_agent_m0_writedata;                                            // random_coordinate_s1_agent:m0_writedata -> random_coordinate_s1_translator:uav_writedata
	wire          random_coordinate_s1_agent_m0_write;                                                // random_coordinate_s1_agent:m0_write -> random_coordinate_s1_translator:uav_write
	wire    [2:0] random_coordinate_s1_agent_m0_burstcount;                                           // random_coordinate_s1_agent:m0_burstcount -> random_coordinate_s1_translator:uav_burstcount
	wire          random_coordinate_s1_agent_rf_source_valid;                                         // random_coordinate_s1_agent:rf_source_valid -> random_coordinate_s1_agent_rsp_fifo:in_valid
	wire  [108:0] random_coordinate_s1_agent_rf_source_data;                                          // random_coordinate_s1_agent:rf_source_data -> random_coordinate_s1_agent_rsp_fifo:in_data
	wire          random_coordinate_s1_agent_rf_source_ready;                                         // random_coordinate_s1_agent_rsp_fifo:in_ready -> random_coordinate_s1_agent:rf_source_ready
	wire          random_coordinate_s1_agent_rf_source_startofpacket;                                 // random_coordinate_s1_agent:rf_source_startofpacket -> random_coordinate_s1_agent_rsp_fifo:in_startofpacket
	wire          random_coordinate_s1_agent_rf_source_endofpacket;                                   // random_coordinate_s1_agent:rf_source_endofpacket -> random_coordinate_s1_agent_rsp_fifo:in_endofpacket
	wire          random_coordinate_s1_agent_rsp_fifo_out_valid;                                      // random_coordinate_s1_agent_rsp_fifo:out_valid -> random_coordinate_s1_agent:rf_sink_valid
	wire  [108:0] random_coordinate_s1_agent_rsp_fifo_out_data;                                       // random_coordinate_s1_agent_rsp_fifo:out_data -> random_coordinate_s1_agent:rf_sink_data
	wire          random_coordinate_s1_agent_rsp_fifo_out_ready;                                      // random_coordinate_s1_agent:rf_sink_ready -> random_coordinate_s1_agent_rsp_fifo:out_ready
	wire          random_coordinate_s1_agent_rsp_fifo_out_startofpacket;                              // random_coordinate_s1_agent_rsp_fifo:out_startofpacket -> random_coordinate_s1_agent:rf_sink_startofpacket
	wire          random_coordinate_s1_agent_rsp_fifo_out_endofpacket;                                // random_coordinate_s1_agent_rsp_fifo:out_endofpacket -> random_coordinate_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_016_src_valid;                                                              // cmd_mux_016:src_valid -> random_coordinate_s1_agent:cp_valid
	wire  [107:0] cmd_mux_016_src_data;                                                               // cmd_mux_016:src_data -> random_coordinate_s1_agent:cp_data
	wire          cmd_mux_016_src_ready;                                                              // random_coordinate_s1_agent:cp_ready -> cmd_mux_016:src_ready
	wire   [17:0] cmd_mux_016_src_channel;                                                            // cmd_mux_016:src_channel -> random_coordinate_s1_agent:cp_channel
	wire          cmd_mux_016_src_startofpacket;                                                      // cmd_mux_016:src_startofpacket -> random_coordinate_s1_agent:cp_startofpacket
	wire          cmd_mux_016_src_endofpacket;                                                        // cmd_mux_016:src_endofpacket -> random_coordinate_s1_agent:cp_endofpacket
	...
	wire          random_coordinate_s1_agent_rp_valid;                                                // random_coordinate_s1_agent:rp_valid -> router_018:sink_valid
	wire  [107:0] random_coordinate_s1_agent_rp_data;                                                 // random_coordinate_s1_agent:rp_data -> router_018:sink_data
	wire          random_coordinate_s1_agent_rp_ready;                                                // router_018:sink_ready -> random_coordinate_s1_agent:rp_ready
	wire          random_coordinate_s1_agent_rp_startofpacket;                                        // random_coordinate_s1_agent:rp_startofpacket -> router_018:sink_startofpacket
	wire          random_coordinate_s1_agent_rp_endofpacket;                                          // random_coordinate_s1_agent:rp_endofpacket -> router_018:sink_endofpacket
	...
	wire          random_coordinate_s1_agent_rdata_fifo_src_valid;                                    // random_coordinate_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_016:in_0_valid
	wire   [33:0] random_coordinate_s1_agent_rdata_fifo_src_data;                                     // random_coordinate_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_016:in_0_data
	wire          random_coordinate_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_016:in_0_ready -> random_coordinate_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_016_out_0_valid;                                                  // avalon_st_adapter_016:out_0_valid -> random_coordinate_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_016_out_0_data;                                                   // avalon_st_adapter_016:out_0_data -> random_coordinate_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_016_out_0_ready;                                                  // random_coordinate_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_016:out_0_ready
	wire    [0:0] avalon_st_adapter_016_out_0_error;                                                  // avalon_st_adapter_016:out_0_error -> random_coordinate_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) random_coordinate_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (random_coordinate_s1_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (random_coordinate_s1_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (random_coordinate_s1_agent_m0_read),             //                         .read
		.uav_write              (random_coordinate_s1_agent_m0_write),            //                         .write
		.uav_waitrequest        (random_coordinate_s1_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (random_coordinate_s1_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (random_coordinate_s1_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (random_coordinate_s1_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (random_coordinate_s1_agent_m0_writedata),        //                         .writedata
		.uav_lock               (random_coordinate_s1_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (random_coordinate_s1_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (random_coordinate_s1_address),                   //      avalon_anti_slave_0.address
		.av_write               (random_coordinate_s1_write),                     //                         .write
		.av_readdata            (random_coordinate_s1_readdata),                  //                         .readdata
		.av_writedata           (random_coordinate_s1_writedata),                 //                         .writedata
		.av_chipselect          (random_coordinate_s1_chipselect),                //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) random_coordinate_s1_agent (
		.clk                     (clk_0_clk_clk),                                         //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (random_coordinate_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (random_coordinate_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (random_coordinate_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (random_coordinate_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (random_coordinate_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (random_coordinate_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (random_coordinate_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (random_coordinate_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (random_coordinate_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (random_coordinate_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (random_coordinate_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (random_coordinate_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (random_coordinate_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (random_coordinate_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (random_coordinate_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (random_coordinate_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (random_coordinate_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (random_coordinate_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (random_coordinate_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (random_coordinate_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (random_coordinate_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (random_coordinate_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (random_coordinate_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (random_coordinate_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (random_coordinate_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (random_coordinate_s1_agent_rf_source_data),             //                .data
		...
		.rdata_fifo_src_ready    (random_coordinate_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (random_coordinate_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (random_coordinate_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                 //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                   //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) random_coordinate_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                         //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (random_coordinate_s1_agent_rf_source_data),             //        in.data
		.in_valid          (random_coordinate_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (random_coordinate_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (random_coordinate_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (random_coordinate_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (random_coordinate_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (random_coordinate_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (random_coordinate_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (random_coordinate_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (random_coordinate_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                 // (terminated)
		.csr_read          (1'b0),                                                  // (terminated)
		.csr_write         (1'b0),                                                  // (terminated)
		.csr_readdata      (),                                                      // (terminated)
	...
	finalprojsoc_mm_interconnect_0_router_002 router_018 (
		.sink_ready         (random_coordinate_s1_agent_rp_ready),            //      sink.ready
		.sink_valid         (random_coordinate_s1_agent_rp_valid),            //          .valid
		.sink_data          (random_coordinate_s1_agent_rp_data),             //          .data
		.sink_startofpacket (random_coordinate_s1_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (random_coordinate_s1_agent_rp_endofpacket),      //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalprojsoc_mm_interconnect_0_router_002 router_019 (
	...
	finalprojsoc_mm_interconnect_0_cmd_mux cmd_mux_017 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalprojsoc_mm_interconnect_0_rsp_demux rsp_demux_017 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	finalprojsoc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                   // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (random_coordinate_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (random_coordinate_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (random_coordinate_s1_agent_rdata_fifo_src_ready), //         .ready
